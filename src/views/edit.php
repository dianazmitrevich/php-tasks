...
<div class="container">
   <div class="row g-5">
      <div class="col-md-7 col-lg-8">
         ...
         <form class="needs-validation" action="/index.php?page=update&id=<?php echo $user['id']; ?>" novalidate="" method="post">
            <div class="row g-3">
               <div class="col-12">
                  <label for="email" class="form-label">Email <span class="text-muted">(Required)</span></label>
                  <input type="email" class="form-control" id="email" value="<?php echo $user['email']?>" name="email" placeholder="you@example.com">
               ...
               <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="name" value="<?php echo $user['name']?>" name="name" placeholder="" value="" required="">
                  <div class="invalid-feedback">
